...
void breakline()
{   char word[100];int wp=0;int fieldno=0;int i;locctr=0;
...
int main()
{   char progname[100],objname[100],blank1[100],blank2[100],blank3[100],startaddress[100],length[100];
    FILE *fp;
    int i;int col=0;
            ...
            {   if(line[0]!='.')//if not a comment line
                {   if(searchOptab()==1)//if found in optab
                    {   if(strcmp(operand,"")!=0)//if there is a symbol in operand field
                        ...
                        strcpy(blank1,"");
                        for(i=0;i<(4-strlen(symbolValue));i++)//4 columns for address.So fill rest with spaces
                            strcat(blank1," ");
                        ...
                        strcpy(blank2,"");
                        for(i=0;i<(4-strlen());i++)//4 columns for address.So fill rest with spaces
                            strcat(blank2," ");
                        strcat(symbolvalue,blank2);
